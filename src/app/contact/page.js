    ...
    <main ref={pageRef} style={{ background: 'var(--cream)', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(to bottom, rgba(8, 15, 14, 0.95) 0%, rgba(0, 61, 55, 0.7) 100%)',
          zIndex: 0,
        }} />
        <div style={{
          position: 'absolute',
        ...
        <div className="section-wrap" style={{ position: 'relative', zIndex: 1, padding: '64px 28px', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            We're a small team with a real mission: make food delivery honest.
          </p>
          ...
          <p style={{
            ...
            If you want to own your work, see real impact, and build something that matters, Kwikkit is the place to do it.
          </p>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '10px', color: 'rgba(253, 248, 242, 0.4)', fontWeight: '600', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Openings</span>
